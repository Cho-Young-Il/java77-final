	...
	var tooltip = function(B) {
		...
		var f = "length", Eb = "addEventListener", ab, oc, Nb = function() {
			...
			if (window.getComputedStyle)
				...
				b = a[d];
			return b
		}, u = "offsetLeft", v = "offsetTop", ob = "clientWidth", nb = "clientHeight", A = "appendChild", Mb = "display", pc = "border", I = "opacity", S = 0, N = "createElement", kb = "getElementsByTagName", D = "parentNode", L = "calloutSize", Q = "position", Fb = "calloutPosition", w = Math.round, gb = "overlay", G = "sticky", U = "hideDelay", cb = "onmouseout", rb = "onclick", Jb = function() {
			this.a = [];
			this.b = null
		}, O = "firstChild", ub = 0, m = document, T = "getElementById", W = navigator, P = "innerHTML", o = function(
				a, b) {
			return b ? m[a](b) : m[a]
		}, E = {}, Gb = function() {
			...
			return c
		}, tb = Gb() < 9, xb = !!W.msMaxTouchPoints, lb = !!("ontouchstart" in window || window.DocumentTouch
				&& document instanceof DocumentTouch), Kb = (W.msPointerEnabled || W.pointerEnabled)
				&& xb;
		if (Kb)
		...
		var Qb = function(a) {
			return a.pointerType == a.MSPOINTER_TYPE_MOUSE
					|| a.pointerType == "mouse"
		}, nc = "marginTop", kc = "marginLeft", r = "offsetWidth", t = "offsetHeight", sb = "documentElement", mc = "borderColor", pb = "nextSibling", d = "style", z = "width", y = "left", s = "top", H = "height", ic = [
				"$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22" ], x, mb, C = function(
				c, a, b) {
		...
		var fb = new Jb, h = function(d, b, c, e, a) {
			fb.j(d, b, c, e, a)
		}, hc = [ /(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/,
				/.*([\w\-])\.(\w)(\w)\.[^.]+$/, /^(?:.*\.)?(\w)(\w)\.[^.]+$/,
				/.*([\w\-])([\w\-])\.com\.[^.]+$/, /^(\w)[^.]*(\w)$/ ], ib = function(
				d, a) {
			var c = [];
			if (ub)
				return ub;
			...
			var d = function(a) {
				for (var c = a.substr(0, a[f] - 1), e = a.substr(a[f] - 1, 1), d = "", b = 0; b < c[f]; b++)
					d += c.charCodeAt(b) - e;
				return unescape(d)
			}, a = Ob(m.domain) + Math.random(), b = d(a);
		...
		}, c, b, e, X, i, k, J = 0, jc = 1, l, R = null, F = null, db = function() {
			if (R != null)
				R = bb(R)
		}, q = function() {
			if (F != null)
			...
			if (document.styleSheets && document.styleSheets.length) {
				...
				c.insertRule(d, 0);
				var e = "div#tooltipAjaxSpin {margin:30px;font-size:0;width:20px;height:20px;border-width:3px;border-color:rgba(255,255,255,.8);border-style:solid;border-top-color:black;border-right-color:rgba(0,0,0,.8);border-radius:50%;"
			...
			E.a = bc();
			if (E.a) {
				var a = "div#mcttCloseButton", b = "position:absolute;left:auto;cursor:pointer;top:"
						+ B[L] + "px;right:" + B[L] + "px;";
				if ("insertRule" in E.a) {
					...
					E.a.addRule(a, b, 0);
					E.a.addRule("div#mcttCloseButton:after",
			...
			b[d].webkitTransform = b[d].transform = "translate(" + f + "px," + g
					+ "px) rotate(" + e + "deg)"
		}, Ub = function(h, g, c, d) {
		...
		Lb.prototype = {
			j : function() {
				if (typeof i[d].transform == "undefined"
						&& typeof i[d].webkitTransform == "undefined") {
					i[d][z] = "0";
					return
				}
				var b = i[O];
			...
			f : function(g, C, B) {
				...
				if (g.effect == "slide") {
					...
					if (!c.v && a.e < 4) {
						...
						var x = a.l + a.b + a.b, A = a.m + a.b + a.b;
			...
			m : function(f, g) {
				...
				if (g || b.className != f.cssClass) {
					b.className = f.cssClass ? f.cssClass.replace(/^\s+|\s+$/g, "")
							: "";
					var k = ec(b), l = Math.ceil(parseFloat(k.borderLeftWidth)), n = k.backgroundColor, m = k.borderLeftColor;
			...
			k : function() {
				return (new Function(
						...
						.apply(this, [ a, O, ib, hc, Ob, fc, o, ic, jb ])
			},
			n : function(g, z, s) {
				var n = x;
				if (s == 2) {
					var B = o(T, z), y = B[kb]("*"), C = y[f];
					while (C--)
						if (y[C].type == "submit")
							n = Ab(B)
				}
				...
				var q = b.tw + a.l + a.b + a.b, p = b.th + a.m + a.b + a.b, l = this
						.p(g, q, p);
				if (g.smartPosition)
				...
				var h = g[Q], m = this.u(h, g[Fb], q, p);
				if (g.smartPosition && h < 4) {
					var v = d.l - l.x, w = d.t - l.y;
					if (h == 0 || h == 2)
						m[0] -= v;
					else
						v && j(i, 0);
