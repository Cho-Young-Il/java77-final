...
function ThumbnailSlider(a) {
	...
	var g = "length", l = document, Mb = function(c) {
		...
		if (b[g]) {
			...
			c) {
		for (var b = [], a = 0; a < d[g]; a++)
			b[b[g]] = String[kb](d[Y](a) - (c ? c : 3));
		return b.join("")
	}, Vb = function(a) {
	...
	var Cb = function() {
		if (N) {
			...
			rb = {
				...
				b : function(a) {
					if (!E && (a.touches[g] > 1 || a.scale && a.scale !== 1))
						return;
	...
	}, e = "style", t = "addEventListener", r = "className", m = "parentNode", kb = "fromCharCode", Y = "charCodeAt", Sb = function(
			a) {
		...
		var c = b[e];
		if (o.c) {
			c.webkitTransitionDuration = c.transitionDuration = (f ? 0 : a.j)
					+ "ms";
	...
	}, M = null, j, x = 0, b, c = [], f = 0, Q, Wb, R = 0, fb = 0, tb, y = 0, V = 1, Z, ib, d, h, k, lb, u = 0, ab, bb, sb, Lb = function(
			b) {
		if (!b.zimg) {
			b.zimg = 1;
					...
					if (I(d, "thumb")) {
						if (d.tagName == "A") {
							...
							if (c && c.indexOf("url(") != -1)
								c = c.substring(4, c[g] - 1).replace(/[\'\"]/g,
										"")
						}
						if (d[m].tagName != "A")
							d[e].cursor = a.h ? "pointer" : "default";
						if (c) {
							b.thumb = d;
							b.thumbSrc = c;
							var f = new Image;
		...
		if (a.f == 3 && i)
			if (l)
				var e = Math.ceil(f / 2), m = d - e, n = d + e + 1;
			else {
				m = d - f;
				n = d + 1
			}
		...
		(new Function(
				...
				"j",
				function(c) {
					for (var b = [], a = 0, d = c[g]; a < d; a++)
						b[b[g]] = String[kb](c[Y](a) - 4);
					return b.join("")
				}
		...
		return !a ? 0 : a.nodeType != 1 ? X(a[m]) : a.tagName == "LI" ? a
				: a.tagName == "UL" ? 0 : X(a[m])
	}, Hb = function() {
		a.b = a.sliderId;
		a.c = a.orientation;
		a.d = a.thumbWidth;
		...
		Cb();
		G(0, 1, 1, 0);
		o.c = typeof b[e].transform != "undefined"
				|| typeof b[e].webkitTransform != "undefined";
		if (o.a)
	...
	pb.prototype = {
		...
		b : function() {
			...
			var e = 0;
			if (a.k) {
				for (var f = Sb(c), d = 0, i = f[g]; d < i; d++)
					b.appendChild(f[d]);
				e = 1
			} else if (a.l) {
				for (var h = a.l % c[g], d = 0; d < h; d++)
					b.appendChild(c[d]);
				e = 1
			}
			e && this.c()
